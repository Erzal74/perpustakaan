                            ...
                            <div
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-sm text-gray-500 mb-3 truncate">
                                        {{ $file->author ?? 'Penulis tidak diketahui' }}</p>
                                    <div class="flex justify-between items-center">
                                        <span
                                            class="text-xs font-medium px-2 py-1 bg-green-100 text-green-800 rounded-full">Direkomendasikan</span>
                                        <div class="flex space-x-2">
                                            <a href="{{ route('user.preview', ['id' => $file->id, 'token' => $file->preview_token]) }}"
                                                class="text-blue-600 hover:text-blue-800 text-sm font-medium">Lihat</a>
                                            <a href="{{ route('user.download', $file->id) }}"
                                                class="text-green-600 hover:text-green-800 text-sm font-medium">Unduh</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
