                        ...
                        @forelse ($files as $file)
                            <div class="p-6 border-b border-gray-200 last:border-b-0">
                                ...
                                <div class="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <form action="{{ route('admin.softfiles.destroy', $file->id) }}" method="POST" class="flex-1">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" onclick="confirmDelete(this)"
                                            class="w-full inline-flex items-center justify-center px-4 py-2.5 text-sm font-medium bg-red-600 text-white rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
